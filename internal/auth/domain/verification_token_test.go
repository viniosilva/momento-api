...
func TestNewVerificationToken(t *testing.T) {
	t.Run("should create a valid verification token", func(t *testing.T) {
		token, err := domain.NewVerificationToken(32)
...
func TestVerificationToken_String(t *testing.T) {
	token, err := domain.NewVerificationToken(16)
	require.NoError(t, err)
