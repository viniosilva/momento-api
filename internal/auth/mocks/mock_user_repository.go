...
// FindVerifiedByEmail provides a mock function for the type MockUserRepository
func (_mock *MockUserRepository) FindVerifiedByEmail(ctx context.Context, email domain.Email) (domain.User, error) {
	ret := _mock.Called(ctx, email)

	if len(ret) == 0 {
		panic("no return value specified for FindVerifiedByEmail")
	}
...
// MockUserRepository_FindVerifiedByEmail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindVerifiedByEmail'
type MockUserRepository_FindVerifiedByEmail_Call struct {
	*mock.Call
}

// FindVerifiedByEmail is a helper method to define mock.On call
//   - ctx context.Context
//   - email domain.Email
func (_e *MockUserRepository_Expecter) FindVerifiedByEmail(ctx interface{}, email interface{}) *MockUserRepository_FindVerifiedByEmail_Call {
	return &MockUserRepository_FindVerifiedByEmail_Call{Call: _e.mock.On("FindVerifiedByEmail", ctx, email)}
}

func (_c *MockUserRepository_FindVerifiedByEmail_Call) Run(run func(ctx context.Context, email domain.Email)) *MockUserRepository_FindVerifiedByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUserRepository_FindVerifiedByEmail_Call) Return(user domain.User, err error) *MockUserRepository_FindVerifiedByEmail_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserRepository_FindVerifiedByEmail_Call) RunAndReturn(run func(ctx context.Context, email domain.Email) (domain.User, error)) *MockUserRepository_FindVerifiedByEmail_Call {
	_c.Call.Return(run)
	return _c
}
