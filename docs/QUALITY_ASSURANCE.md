...
2. **Priorização** (quando aplicável):
   ...
   - Média: Validações importantes e regras de negócio
   - Baixa: Edge cases e casos extremos
3. **Cobertura** seguindo as diretrizes de brainstorming abaixo
...
- **Alta Prioridade:** Caminho feliz, validações críticas de negócio, segurança básica
- **Média Prioridade:** Validações de formato, edge cases comuns, regras de negócio secundárias
- **Baixa Prioridade:** Casos extremos, testes de stress, cenários muito específicos

## Exemplo de Entrada

Você receberá uma História de Usuário ou Requisito de Negócio. Exemplo:
```
**História de Usuário:**
...
### Cenários Positivos (Alta Prioridade)
...
#### Validações de Formato (Média Prioridade)
...
#### Regras de Negócio (Alta Prioridade)
- Deve retornar erro quando o e-mail já estiver cadastrado no sistema
